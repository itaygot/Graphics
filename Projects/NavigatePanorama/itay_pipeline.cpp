...
#include "itay_pipeline.h"

const Matrix4f& IPipeline::GetProjTrans() 
{
...
const Matrix4f& IPipeline::GetVPTrans()
{
    GetViewTrans();
    GetProjTrans();
...
const Matrix4f& IPipeline::GetWorldTrans()
{
    Matrix4f ScaleTrans, RotateTrans, TranslationTrans;

    ScaleTrans.InitScaleTransform(m_scale.x, m_scale.y, m_scale.z);
    //RotateTrans.InitRotateTransform(m_rotateInfo.x, m_rotateInfo.y, m_rotateInfo.z);
	RotateTrans.InitRotateTransform(m_rotation);
...
const Matrix4f& IPipeline::GetViewTrans()
{
...
const Matrix4f& IPipeline::GetWVPTrans()
{
    GetWorldTrans();
    GetVPTrans();
...
const Matrix4f& IPipeline::GetWVOrthoPTrans()
{
    GetWorldTrans();
    GetViewTrans();
...
const Matrix4f& IPipeline::GetWVTrans()
{
	GetWorldTrans();
    GetViewTrans();
...
const Matrix4f& IPipeline::GetWPTrans()
{
